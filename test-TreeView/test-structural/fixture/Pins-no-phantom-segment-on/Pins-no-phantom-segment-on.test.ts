...
suite('Tree scenarios', function () {
    ...
    suite('Pins', function () {
        ...
        test('нет фантомного сегмента при pathCompression = "on"', async function () {
            ...
            assert.strictEqual(result,
                [
                    '━[★[ Pins ]]                                   ',
                    '  ├─ Pins-no-phantom-segment-on (Workspace)     ',
                    '  │  └─ aaa › bbb › ccc                           ',
                    '  │     ├─ ddd                                 ',
                    '  │     │  └─ ▶ task-in-ddd                    ', // BUG`а нет
                    '  │     └─ ▶ task-in-ccc                       ',
                    '  └─ folder                                    ',
                    '     └─ aaa › bbb › ccc                           ',
                    '        ├─ ▶ task-in-ccc                       ',
                    '        └─ ddd                                 ',
                    '           └─ ▶ task-in-ddd                    ', // BUG`а нет
                    '━[F[ Pins-no-phantom-segment-on (Workspace) ]] ',
                    '  └─ aaa                                       ',
                    '     └─ bbb                                    ',
                    '        └─ ccc                                 ',
                    '           ├─ ▶ task-in-ccc                    ',
