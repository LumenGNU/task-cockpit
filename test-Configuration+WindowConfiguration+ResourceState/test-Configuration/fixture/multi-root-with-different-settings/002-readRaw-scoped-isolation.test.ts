...
// Тест ожидает что в глобальной области определена задача 'task-in-user-profile' (VSC_DATA_DIR в test runner).
// Workspace область теста содержит 'task-in-workspace'.
