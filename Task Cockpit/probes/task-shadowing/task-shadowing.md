...
~~~
Сценарий | Где "My Task" доступен | Что запускается при клике на 'My Task'
         |                        | -----------------------------------------
         |                        |  U  |  W  |  P
---------|------------------------|-----|-----|------------------------------
Сц. 1    |   +U +W +P             |  U  |  U  |  U
...
~~~
Сценарий | Где "My Task" доступен | Что запускается при клике на DependsOn in (X)
         |                        | ---------------------------------------------
         |                        |  U  |  W  |  P
---------|------------------------|-----|-----|----------------------------------
Сц. 1    |   +U +W +P             |  U  |  W  |  P
...
- "dependsOn" принимает только string | string[] — объектной адресации не существует (я о ней не знаю).
