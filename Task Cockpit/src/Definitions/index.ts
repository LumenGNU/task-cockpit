/** @file Workspace/Definitions/index.ts */
/** @module Definitions */
...
import type { Definition } from '../type.d/Definition';
import type { TaskSource } from '../type.d/TaskSource';
import type { TaskName } from '../type.d/TaskName';
import type { Group, TaskGroup } from '../type.d/TaskGroup';
...
function extract(jsoncContent: string, jsonPath: Readonly<JSONC.JSONPath>): Raw[] {
    ...
    const raw: unknown = jsonPath.reduce((node, key) => {
