...
import { Definition } from '../type.d/Definition';
...
interface Runnable {
    ...
    readonly entity: Hierarchy.Data<Definition>;
    readonly parentNode: ParentNode;
}

interface Group {
    readonly kind: TC.EntityKind.Group;
    readonly entity: Hierarchy.Branch<Definition>;
    readonly parentNode: ParentNode;
}

interface RunnableGroup {
    readonly kind: TC.EntityKind.RunnableGroup;
    readonly entity: Hierarchy.Data<Definition> & Hierarchy.Branch<Definition>;
    readonly parentNode: ParentNode;
}
...
const TreeModel = {
    ...
    build(
        treeInput: TC.DeepReadonly<TreeInput>
    ): {
