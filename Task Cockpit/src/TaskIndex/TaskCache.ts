...
class TaskCache implements vscode.Disposable {

    #rPromise: RevocablePromise<Readonly<TaskIndex>> | null = null;
    ...
    public update(idleTtlMs?: number): void {
     ...
     *  самого {@linkcode TaskCache}. Количество итераций цикла равно
    ...
    public async get(): Promise<TaskIndex | null> {
    ...
    #scheduleIdleEviction(owner: Promise<Readonly<TaskIndex>>): void {
    ...
    #reScan(): Promise<Readonly<TaskIndex>> {
