 ...
 *  */
function buildTaskDefinitionsMap(scope: Scope): ReadonlyMap<TaskName, TaskDefinition> {
...
function buildAvailableNames(scope: Scope): ReadonlySet<TaskName> {
...
function getRawTaskDefinitions(scope: Scope): ReadonlyArray<RawTaskDefinition> | undefined {
    const configuration =
...
function getIsolatedTasks(configuration: Readonly<WorkspaceConfiguration>, scope: Scope): ReadonlyArray<RawTaskDefinition> | undefined {
