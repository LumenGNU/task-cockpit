            ...
            suite('Один сегмент', function () {
                ...
                test('компрессия off', function () {
                    assert.deepStrictEqual(
                        findDuplicateIds(HierarchyModel.buildHierarchy(specsDict, HierarchyModel.PathCompression.OFF)),
                        []
                    );
                });
                ...
                test('компрессия on', function () {
                    assert.deepStrictEqual(
                        findDuplicateIds(HierarchyModel.buildHierarchy(specsDict, HierarchyModel.PathCompression.ON)),
                        []
                    );
                });
                ...
                test('компрессия on-aggressive', function () {
                    assert.deepStrictEqual(
                        findDuplicateIds(HierarchyModel.buildHierarchy(specsDict, HierarchyModel.PathCompression.ON_AGGRESSIVE)),
                        []
                    );
                });
