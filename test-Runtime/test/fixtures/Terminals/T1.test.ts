...
import { TerminalsSnapshot } from '../../../src/type.d/TerminalsSnapshot';
...
async function awaitTerminalsSnapshot(trms: Terminals, timestamp: number, ms: number = 3_000): Promise<TerminalsSnapshot> {
